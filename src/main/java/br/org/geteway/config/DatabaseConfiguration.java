...
import br.org.geteway.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("br.org.geteway.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("br.org.geteway.repository.search")
